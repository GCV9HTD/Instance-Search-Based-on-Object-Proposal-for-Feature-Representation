...
# @pysnooper.snoop('/home/yz/cde/ProposalYOLO/log/file.log')
def test(config):
        ...
        for idx, detections in enumerate(batch_detections):
            ...
            if detections is not None:
                ...
                for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                    ...
                    ax.add_patch(bbox)
                    # Add label
                    # plt.text(x1, y1, s=classes[int(cls_pred)] + ' %.2f' % (conf.item() * cls_conf.item()), color='white',
            ...
            plt.savefig('output/{}.png'.format(name), bbox_inches='tight', pad_inches=0.0)
            plt.close()
